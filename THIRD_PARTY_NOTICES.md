...
MUBSIR - مبصر's original source is licensed under MIT. Its dependency lockfile records the complete dependency graph and exact runtime versions.
...
- MUBSIR - مبصر modifications: none; consumed as an npm dependency.
...
- MUBSIR - مبصر modifications: reimplemented as typed worker-owned adapter code with pinned Hugging Face assets, progress reporting, browser cache management, cancellation integration, and reader timing output.
...
- MUBSIR - مبصر modifications: none; loaded on demand as an npm dependency and rendered with Mermaid's strict security mode.
...
- MUBSIR - مبصر modifications: packaged as a small local Svelte component with configurable size and stroke width.
